...
| File | What it is |
|---|---|
| `PLAN-data-workflow-and-linkage-grammar.md` | Master roadmap + historical record of the whole effort. Top banner has the current status; the backlog is the three prompts below. |
