...
vignette: >
  ...
  %\VignetteIndexEntry{2. MSEs: An Introduction}
...
mse1 <- run_mse(
  ...
  nsim = 10, 
  assessment_period = 2,
  sampling_period = c(1, 2) # Fishery = fleet 1 (annual), BTS = fleet 2 (biannual)
)
```
...
mse_summ3 <- mse_summary(mse3); mse_summ3$MSE = 3
mse_summ4 <- mse_summary(mse4); mse_summ4$MSE = 4
