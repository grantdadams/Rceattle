...
# Install `Rceattle`:
```{R eval = FALSE}
install.packages("yourdir/Rceattle_0.0.0.9000.tar.gz", type="source")
```
...
```{R}
ss_run <- Rceattle::est_ceattle(TMBfilename = "ceattle_v01_02", 
                   data_list = BS2017SS,
...
ms_run <- est_ceattle(TMBfilename = "ceattle_v01_02", 
...
ss_sim_run <- est_ceattle(TMBfilename = "ceattle_v01_02", 
                   data_list = ss_sim,
                   inits = NULL, # Initial parameters = 0
                   file_name = NULL, # Don't save
                   debug = 0, # Estimate
...
ms_sim_run <- est_ceattle(TMBfilename = "ceattle_v01_02", 
                   data_list = ms_sim,
                   inits = NULL, # Initial parameters = 0
                   file_name = NULL, # Don't save
                   debug = 0, # Estimate
...
```{R eval = FALSE}
ss_re <- est_ceattle(TMBfilename = "ceattle_v01_02", 
                   data_list = ss_sim,
                   inits = NULL, # Initial parameters = 0
                   file_name = NULL, # Don't save
                   debug = 0, # Estimate
