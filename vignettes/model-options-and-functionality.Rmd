...
| `4` | `"NonEquilibriumScaled"` | Non-equilibrium with init devs and R<sub>0</sub>-scaled by F<sub>init</sub> (single multiplicative offset on R<sub>init</sub>) |
| `5` | `"EquilibriumScaled"` | Regime equilibrium: R<sub>0</sub>-scaled by F<sub>init</sub>, init devs mapped OFF. Mirrors SS3's `SR_regime` mechanism. |
