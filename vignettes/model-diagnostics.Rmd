...
Composition-data OSA residuals (`"comp"`/`"caal"`/`"diet"`) require extra
observations to be built during the fit, so set `fit_control(osa = TRUE)` when
you want them. Aggregate index and catch OSA residuals, and
`process_residuals()`, are available for any fit.
