...
```{r osa, eval = FALSE}
# Aggregate (catch + index) residuals -- fast
...
# Composition residuals (slower) and the same plots through the familiar
# composition plotter:
plot_comp(model_1, residual_type = "osa")

# residuals() also exposes them in the common residual schema:
residuals(model_1, type = "osa")
```
