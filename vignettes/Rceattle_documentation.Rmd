...
Multiple age-based selectivity functions are supported by Rceattle. They are controlled by `Selectivity_index`, `Selectivity`, `N_sel_bins`, `Time_varying_sel`, `Sel_sd_prior`, and `Bin_first_selected` in fleet_control sheet of an Rceattle data file. They are defined as follows:
...
* `Sel_sd_prior`:	The sd to use for the random walk of time varying selectivity if set to 1. 
...
Input:
`Selectivity = 2`, `N_sel_bins = 6`, `Time_varying_sel = 12.5`, `Sel_sd_prior = 200`, and `Bin_first_selected = 1`
...
### Logistic
Input:
`Selectivity = 1`, `N_sel_bins = NA`, `Time_varying_sel = 0`, and `Sel_sd_prior = NA`
...
Input:
`Selectivity = 1`, `N_sel_bins = NA`, and `Sel_sd_prior = 0.1` or other desired value. 
...
### Double logistic
Input:
`Selectivity = 3`, `N_sel_bins = NA`, `Time_varying_sel = 0`, and `Sel_sd_prior = NA`
...
Input:
`Selectivity = 3`, `N_sel_bins = NA`, `Time_varying_sel = 5`, and `Sel_sd_prior = NA`
...
### Descending logistic
Input:
`Selectivity = 4`, `N_sel_bins = NA`, `Time_varying_sel = 0`, and `Sel_sd_prior = NA`
...
Input:
`Selectivity = 4`, `N_sel_bins = NA`, `Time_varying_sel = 1` or `2` , and `Sel_sd_prior = NA`
...
Input:
`Selectivity = 5`, `N_sel_bins = 6`, `Time_varying_sel = NA`,  `Sel_sd_prior = NA`, and `Bin_first_selected = `$A_{min}$
