...
parameters_table <- function(){
  ...
  params_extra <- rbind(params_extra, c("Estimated total catch", "$\\hat{C}_{i,y}$", "D", "tc_biom_est"))
  
  params_extra <- rbind(params_extra, c("Total catch", "$B_{ij,y} = N_{ij,y} W_{ij,y}$", "E", "tc_obs"))
