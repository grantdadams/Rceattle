...
Type <- c(rep("M", 5), rep("I", 12), rep("E", 8), rep("P", 3), rep("F", 12), rep("D", 9))

# Value

Parameters <- data.frame(cbind(Parameter, Definition, Type))
# colnames(Parameters) = c("Parameter", "Definition")

knitr::kable(Parameters, escape = T, format = "html")
```
