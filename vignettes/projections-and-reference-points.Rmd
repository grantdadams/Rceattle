...
Setting `random_rec = TRUE` treats log-recruitment deviations as random effects, marginalised via the Laplace approximation, rather than as penalised fixed effects. This carries recruitment process uncertainty through into the projections.
