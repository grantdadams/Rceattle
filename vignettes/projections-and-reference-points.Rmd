...
The `Proj_F_proportion` column in `fleet_control` controls how projected F is split across fleets when there are multiple fisheries targeting the same species (values must sum to 1 per species).
