...
Values 1, 3 and 5 -- every length-based mode -- are blocked at runtime pending validation of the growth-model integration: `data_check()` errors with "Length-based suitability (suitMode 1, 3, or 5) is not yet implemented". Use `suitMode = 0` (empirical), or a weight-based mode: `2`, `4` or `6`.
