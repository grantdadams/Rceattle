...
## A note on M1 in the Bering Sea datasets

A key data difference between `BS2017SS` and `BS2017MS` is `M1_base` — the residual natural mortality before predation. In the multi-species dataset, M1 is lower because predation (M2) accounts for a portion of total mortality. Applying `msmMode = 1` to the single-species dataset without adjusting M1 will inflate total mortality.
