...
In default single-species mode (`msmMode = 0`) you can omit any of these by simply not setting the field on the list.
...
Each row defines one fleet (fishery or survey) and controls how it is modelled. Multiple fleets can target the same species.
...
simData$fleet_control <- data.frame(
  ...
  Sel_norm_bin             = NA,    # bin to normalise selectivity from (optional)
...
#               5 = equilibrium, F_init = 0, seeded by the first-year
#                   recruitment instead of R_init, no init deviations
#
