...
Rather than reading the table below by hand, ask `data_requirements()`: it reports, for a given configuration, which blocks are **Required**, **Optional** (used if supplied, otherwise default-filled), or **Ignored** (not consulted because the feature is off) — the exact conditions `data_check()` enforces at fit time.
