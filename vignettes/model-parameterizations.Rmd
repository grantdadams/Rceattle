...
$\omega_{f_iy} \sim N(0,$`Time_varying_q_sd`$)$ where `Time_varying_q_sd` is either fixed `Time_varying_q = 1` or estimated `Time_varying_q = 2` & `random_q = TRUE` in \function{fit_mod}
