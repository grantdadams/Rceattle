...
.rce_column_schema <- function() {
  rows <- list(
    ...
    .rce_col("Selectivity_dimension", "fleet_control", "\"Age\" or \"Length\".", type = "character", meta = FALSE, has_default = TRUE, default = "Age", default_msg = "'Selectivity_dimension' not specified in 'fleet_control', assuming 'Age'"),
    ...
    .rce_col("Sel_curve_pen3", "fleet_control", "Deviation-magnitude penalty weight (Sel_curve_pen3) for non-parametric / LogisticPM selectivity.", meta = FALSE, has_default = TRUE, default = 0, default_msg = "'Sel_curve_pen3' not specified in 'fleet_control', assuming '0'", default_msg_when = "np_hake"),
    ...
    .rce_col("Sel_start_year", "fleet_control", "First year the fleet's time-varying selectivity deviations are estimated and penalized (NA -> earliest year of data across fleets sharing the Selectivity_index, bounded below by styr).", type = "integer", meta = FALSE, has_default = TRUE, default = NA),
    ...
    .rce_col("Sel_shape_sd", "fleet_control", "Shape/smoothness selectivity penalty expressed as a standard deviation (an intuitive alternative to Sel_curve_pen1); weight = 1/(2*sd^2). NonParametric (2/9) and LogisticPM (11).", meta = FALSE),
    .rce_col("Sel_curvature_sd", "fleet_control", "2nd-difference curvature selectivity penalty expressed as a standard deviation (Sel_curve_pen2); NonParametric-only.", meta = FALSE),
    .rce_col("Sel_devmag_sd", "fleet_control", "Deviation-magnitude selectivity penalty expressed as a standard deviation (Sel_curve_pen3). NonParametric (2/9) and LogisticPM (11).", meta = FALSE),
    .rce_col("Sel_shape_dir", "fleet_control", "Direction of the (directional-mode) NonParametric shape penalty when Sel_shape_sd is used: \"Decreasing\" (default) or \"Increasing\".", type = "character", meta = FALSE),
    .rce_col("Sel_pen_first_bin", "fleet_control", "First bin (age or length) for the non-parametric shape penalty (NA -> Bin_first_selected).", type = "integer", meta = FALSE, has_default = TRUE, default = NA, aliases = "Sel_pen_first_age"),
    .rce_col("Sel_pen_last_bin", "fleet_control", "Last (left) bin of the shape-penalty pairs (NA -> nbins-2).", type = "integer", meta = FALSE, has_default = TRUE, default = NA, aliases = "Sel_pen_last_age"),
    .rce_col("Sel_shape_mode", "fleet_control", "Shape-penalty mode: \"Directional\" (default) or \"Smooth\" (two-sided d^2, RTMB).", type = "character", meta = FALSE, has_default = TRUE, default = NA),
    .rce_col("Sel_avgsel_pen", "fleet_control", "Weight on the AMAK avgsel base-level penalty (type 9); 0 = off (default), 10 matches AMAK.", meta = FALSE, has_default = TRUE, default = 0),
    .rce_col("Sel_cap_bin", "fleet_control", "NonParametricRPM bin cap (NA -> no cap).", type = "integer", meta = FALSE, has_default = TRUE, default = NA, aliases = "Sel_cap_age"),
    .rce_col("Sel_norm_bin1", "fleet_control", "Age/length bin at which selectivity = 1. \r\nIf NA, it will not normalize selectivity. \r\nIf < 0, will normalize selectivity by the max.", type = "integer", has_default = TRUE, default = NA, default_msg = "'Sel_norm_bin1' not specified in 'fleet_control', assuming 'NA'", aliases = "Age_max_selected"),
    .rce_col("Sel_norm_bin2", "fleet_control", "Upper age/length bin for selectivity normalization (default = NA). If NA, does not use the age range, If not NA, uses mean selectivity between `Age_max_selected` and `Age_max_selected_upper`", type = "integer", has_default = TRUE, default = NA, default_msg = "'Sel_norm_bin2' not specified in 'fleet_control', assuming 'NA'", aliases = "Age_max_selected_upper"),
    .rce_col("Comp_loglike", "fleet_control", "Composition data distribution:\r\n-1 = AFSC multinomial\r\n0 = full multinomial\r\n1 = dirichlet-multinomial", type = "switch", allowed = "comp_loglike_map", has_default = TRUE, default = "MultinomialAFSC", default_msg = "'Comp_loglike' not specified in 'fleet_control', assuming 'MultinomialAFSC'"),
    ...
    .rce_col("CAAL_loglike", "fleet_control", "Composition data distribution:\r\n0 = full multinomial\r\n1 = dirichlet-multinomial", type = "switch", allowed = "comp_loglike_map", has_default = TRUE, default = "Multinomial", default_msg = "'CAAL_loglike' not specified in 'fleet_control', assuming 'Multinomial'"),
    ...
    .rce_col("weight1_Numbers2", "fleet_control", "1 = catch/index is weight (kg) the observation \r\n2 = catch/index is in numbers", type = "integer"),
    ...
    .rce_col("Q_index", "fleet_control", "index to use if catchability coefficients are to be set the same", type = "integer"),
    ...
    .rce_col("Q_init", "fleet_control", "Starting value or fixed value for catchability", aliases = "Q_prior"),
    .rce_col("Q_sd_prior", "fleet_control", "Standard deviation for q prior"),
    ...
    .rce_col("Index_loglike", "fleet_control", "Survey/index biomass observation likelihood family. 0 or \"Lognormal\" (default) = independent lognormal; \"MVN\"/\"MVNORM\" use a multivariate normal with a user-supplied covariance in index_cov.", type = "switch", allowed = "index_loglike_map", meta = FALSE, has_default = TRUE, default = "Lognormal"),
    .rce_col("Month", "fleet_control", "Observation month for the fleet (0 = not specified).", type = "integer", meta = FALSE, has_default = TRUE, default = 0, default_msg = "'Month' not specified in 'fleet_control', assuming 0"),
    .rce_col("proj_F_prop", "fleet_control", "The proportion of future fishing mortality assigned to this fleet"),
