...
.rce_column_schema <- function() {
  rows <- list(
    ...
    .rce_col("Sel_shape_sd", "fleet_control", "Shape/smoothness selectivity penalty expressed as a standard deviation (an intuitive alternative to Sel_curve_pen1); weight = 1/(2*sd^2). NonParametric (2/9/13/14) and LogisticPM (11).", meta = TRUE),
    .rce_col("Sel_curvature_sd", "fleet_control", "2nd-difference curvature selectivity penalty expressed as a standard deviation (Sel_curve_pen2); NonParametric only (2/9/13/14).", meta = TRUE),
