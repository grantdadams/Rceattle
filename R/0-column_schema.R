...
.rce_column_schema <- function() {
  rows <- list(
    ...
    .rce_col("Index_loglike", "fleet_control", "Survey/index biomass observation likelihood family. 0 or \"Lognormal\" (default) = independent lognormal; \"MVN\"/\"MVNORM\" use a multivariate normal with a user-supplied covariance in index_cov.", type = "switch", allowed = "index_loglike_map", meta = TRUE, has_default = TRUE, default = "Lognormal"),
