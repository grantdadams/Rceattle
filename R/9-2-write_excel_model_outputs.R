...
write_results <- function( Rceattle, file = "Rceattle_results.xlsx" ){
  ...
  colnames(xcel_list$srv_comp_hat)[grep("Comp_", colnames( xcel_list$srv_comp_hat))] <- paste0("Comp_hat_", 1:length(grep("Comp_", colnames( xcel_list$srv_comp_hat))))
  ...
  colnames(xcel_list$fsh_comp_hat)[grep("Comp_", colnames( xcel_list$fsh_comp_hat))] <- paste0("Comp_hat_", 1:length(grep("Comp_", colnames( xcel_list$fsh_comp_hat))))
