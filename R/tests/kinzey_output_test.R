...
ms_run_3 <- Rceattle(TMBfilename = "CEATTLE_BSAI_MS_v01_02",
...
ms_run_4 <- Rceattle(TMBfilename = "CEATTLE_BSAI_MS_v01_02",
                     data_list = data_list_ms,
                     inits = ss_run$estimated_params, # Initial parameters from ss run
                     file_name = NULL, # Don't save
                     debug = 1, # Estimate
...
ms_run_5 <- Rceattle(TMBfilename = "CEATTLE_BSAI_MS_v01_02",
                     data_list = data_list_ms,
                     inits = ss_run$estimated_params, # Initial parameters from ss run
                     file_name = NULL, # Don't save
                     debug = 1, # Estimate
