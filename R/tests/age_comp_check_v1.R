# Function to return relative error of survey age comps using outputs from TMB or ADMB based CEATTLE
...
age_comp_comparison <- function( species, rep, tmp, ADMB_TMB = model){
