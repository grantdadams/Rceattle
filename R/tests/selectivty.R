...
#     }
rm(list=ls())
load(path.expand("data/BSAI/BS_MS_10_Loops_Files_Corrected/CEATTLE_results.Rdata"))
mod<-tmp
tmp<-read.csv(path.expand("data/BSAI/BS_MS_10_Loops_Files_Corrected/ceattle_est.std"),header=T)
...
fsh_sel <- Fsel(fsh_sel_coff,nselages,nages)
