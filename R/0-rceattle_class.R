...
#'     the composition observation data on demand from any fit. Pass its
#'     arguments through `...`; note that `method = "cdf"` forms no conditional
#'     mean, so `Fitted` is `NA` for every row under it.}
