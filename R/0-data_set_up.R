...
set_updata <- function(){
  library(Rceattle)
  BS2017SS <- build_dat(ctlFilename = "asmnt2017_0A_corrected", dat_dir = "~/Documents/GitHub/RceattleRuns/Data/data-raw/BSAI/BS_MS_5_Loops_Files/dat files", nspp = 3) # "C:/Users/Grant Adams/Documents/GitHub/RceattleRuns/Data/data-raw/BSAI/BS_MS_5_Loops_Files/dat files"
