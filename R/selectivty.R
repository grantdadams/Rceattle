...
#     }
rm(list=ls())
load(path.expand("~/GitHub/CEATTLE/docs/2017_MSMassmnt/New Folder With Items 2/assmnt_2017_0/results/CEATTLE_results.Rdata")) 
mod<-tmp
tmp<-read.csv(path.expand("~/GitHub/CEATTLE/docs/2017_MSMassmnt/New Folder With Items 2/assmnt_2017_0/results/ceattle_est.std"),header=T)
