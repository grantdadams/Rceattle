...
.QUANT_INFO <- local({
  ...
  rbind(
    ...
    r("jnll_comp", "likelihood",
      "Weighted negative log-likelihood by component and fleet or species. Rows are named; columns count FLEETS on rows 1-8 and SPECIES on rows 9-21, so rowSums() pools across two different axes.",
