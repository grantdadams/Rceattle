...
#' \item{Estimate_index_sd}{Estimate survey/index observation SD (0 = use the CV from index_data, 1 = estimate, 2 = analytically estimate following Ludwig and Walters 1994). (Formerly \code{Estimate_survey_sd}; renamed on read.)}
#' \item{Index_sd_prior}{Starting/fixed value for the index observation SD, used when Estimate_index_sd = 1. (Formerly \code{Survey_sd_prior}; renamed on read.)}
#' \item{Estimate_catch_sd}{Estimate fishery/catch observation SD (0 = use the CV from catch_data, 1 = estimate, 2 = analytically estimate following Ludwig and Walters 1994).}
#' \item{Catch_sd_prior}{Starting/fixed value for the catch observation SD, used when Estimate_catch_sd = 1.}
