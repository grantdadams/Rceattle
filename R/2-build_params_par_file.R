# Function to read a TMB cpp file and construct parameter objects given a specified size. Updates the parameters using a par file.
# Grant Adams Oct 2018
...
build_params <-
  function(data_list,
    ...
    param_list$ln_mn_rec <-
      replace(param_list$ln_mn_rec, values = 12.5)
