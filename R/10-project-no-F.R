...
remove_F <- function(Rceattle){
  ...
  Rceattle <- fit_mod(
    ...
    dsem = build_DSEM(sem = Rceattle$data_list$dsem_settings$sem,
                      family = Rceattle$data_list$dsem_settings$family,
                      all_vars = Rceattle$data_list$dsem_settings$all_vars,
                      estimate_projection = Rceattle$data_list$dsem_settings$estimate_projection),
