...
#File
ceattle
#datafile_name #dat_input_files/01_assesment_2017/test_0Jim.dat
...
#retrofile_name
dat_input_files/aclim/retro_data2018_long_ext_bcs.dat
#futfile_name
dat_input_files/aclim/proj_data2018_long_ext_bcs.dat
#catch_in_name
dat_input_files/01_assesment_2017/catch_in.dat
#setC_name 
dat_input_files/01_assesment_2017/set_catch.dat
#setF_name 
dat_input_files/set_FabcFofl_0.dat
...
#1 1 #Individual stocks  fished  to  B40% where B0 is set to the B0 from no climate (using B0set in .ctl file)                                    
#1 1 #Individual stocks  fished  to  B40%;
#1 2 #Individual stocks  fished  to  B1 22 #Individual stocks  fished  to  B40%; constrained such  that  no  B0(spp) 40%; constrained such  that  no  B0(spp) <.35  B0(spp)
#<.35  B0(spp); given 2 mT cap & ATF ~ mean F (i.e., plk C<=1.35 mT, and pcod=0.95*ABC) 
