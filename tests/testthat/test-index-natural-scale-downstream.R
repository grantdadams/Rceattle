...
# `MVN` (1), `MVNORM` (2) and `Normal` (3) are natural-scale families whose sd is
# ABSOLUTE, in the units of the index. Applying a log-scale formula to the second
# group does not error, it silently returns nonsense: `sigma^2 / 2` becomes a
