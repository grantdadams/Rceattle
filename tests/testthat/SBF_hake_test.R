...
ss_run$quantities$jnll #2109.864
...
inits$log_gam_a = c(0, 3.1)  # Mean log weight ratio for SBF, 0 for other species (pred/prey)
...
run_ms_LN_3$quantities$jnll # 2415.506
...
run_ms_LN_4$quantities$jnll #2233.385
