...
# 3. Create the diet comparison plot using the new helper function
comparison_df <- match_diet_preds(
  data_list = ms_run2$data_list,
  quantities = ms_run2$quantities
)

# 4. Plot the results
if (!is.null(comparison_df)) {
  plot(
    x = comparison_df$Stomach_proportion_by_weight,
    y = comparison_df$Est_diet,
...
# 3. Create the diet comparison plot using the new helper function
comparison_df <- match_diet_preds(
  data_list = ms_run3$data_list,
  quantities = ms_run3$quantities
)
...
# 3. Create the diet comparison plot using the new helper function
comparison_df <- match_diet_preds(
  data_list = ms_run4$data_list,
  quantities = ms_run4$quantities
)
...
# 3. Create the diet comparison plot using the new helper function
comparison_df <- match_diet_preds(
  data_list = ms_run5$data_list,
  quantities = ms_run5$quantities
)
...
# 3. Create the diet comparison plot using the new helper function
comparison_df <- match_diet_preds(
  data_list = ms_run6$data_list,
  quantities = ms_run6$quantities
)
