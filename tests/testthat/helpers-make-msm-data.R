...
make_msm_test_data <- function(
  ...
  simData$fleet_control <- data.frame(
    ...
    Selectivity = "Logistic", # age or length based logistic
    Selectivity_dimension = ifelse(use_size_sel, "Length", "Age"), # age or length based logistic
    N_sel_bins = NA,
    Sel_curve_pen1 = NA,
    Sel_curve_pen2 = NA,
    Time_varying_sel = 0,
