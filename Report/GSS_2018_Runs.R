...
ms_run_no_re <- Rceattle(data_list = data_list_ms, ctlFilename = "asmnt2017_2A_corrected", TMBfilename = "CEATTLE_BSAI_MS_v01", dat_dir =  "data/BS_MS_Files/dat files/", inits = "ceattle.par", debug = FALSE, random_rec = FALSE, niter = 4, file_name = "Report/GSS_MS_no_re")
ms_rep_no_re <- ms_run_no_re$rep

###################################################
# Run in MS mode using par files and random recruitment
load("data/BS_MS_Files/2017_assessment_data_list.RData")
ms_run_re <- Rceattle(data_list = data_list_ms; ctlFilename = "asmnt2017_2A_corrected"; TMBfilename = "CEATTLE_BSAI_MS_v01"; dat_dir =  "data/BS_MS_Files/dat files/"; inits = "ceattle.par"; debug = FALSE; random_rec = TRUE; niter = 4; file_name = "Report/GSS_MS_no_re")
