...
ms_admb_ssdat <- Rceattle(data_list = data_list_ss, ctlFilename = "asmnt2017_2A_corrected", TMBfilename = "CEATTLE_BSAI_MS_v01", dat_dir =  "data/BS_MS_Files/dat files/", inits = "ceattle.par", debug = TRUE, random_rec = FALSE, niter = 10, file_name = "Report/FISH559/Models/ms_admb_10")
...
for(i in 1:20){
  ...
  ms_run_no_re <- Rceattle(data_list = data_list_ss, ctlFilename = "asmnt2017_2A_corrected", TMBfilename = "CEATTLE_BSAI_MS_v01", dat_dir =  "data/BS_MS_Files/dat files/", inits = ss_run_no_re$final_params, debug = FALSE, random_rec = FALSE, niter = i, file_name = paste0("Report/FISH559/Models/ms_no_re_5optim_ssdat_", i))
...
other_food_percent <- seq(0.05, 1, by = 0.05 )

for(i in 1:length(other_food_percent)){
