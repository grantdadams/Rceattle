...
sem_iid = "
  ...
  ScaledBT -> ScaledBT, 1, AR_BT
  ScaledBT -> recdevs1, 1, BT_to_R
  recdevs1 <-> recdevs1, 0, sigmaR1, 1
"
model2 <- Rceattle::fit_mod(data_list = model1$data_list,
...
sem_3spp = "
  ...
  recdevs2 -> recdevs1, 0, R2_to_R1
  recdevs3 -> recdevs1, 0, R3_to_R1
"
