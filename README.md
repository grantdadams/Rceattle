...
* dev: introduces internal growth estimation and conditional-age-at-length data and is currently the most up to date. It also includes extensive testing. **All development and new models should go from here!** This branch will be pushed to master in summer 2026.
* main: This is the last branch that was used in a publication.
