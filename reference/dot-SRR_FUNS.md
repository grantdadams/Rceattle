...
string aliases. The env-driven codes (1, 3, 5) still work with a
soft-deprecation warning – their structural part is identical to 0 / 2 /
4 respectively, and the env effect is expressed via the `linkages`
argument to
