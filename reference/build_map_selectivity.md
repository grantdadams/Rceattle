...
sensu Ianelli et al 2018 3 = "DoubleLogistic" 4 = "DescendingLogistic" 5
= "Hake" non-parametric selectivity sensu Taylor et al 2014 (Hake) 6 =
"2DAR1" across age x year 7 = "3DAR1" across age x cohort x year (Cheng
et al 2024)
...
, non-parametric, or hake (`Selectivity = 1, 2, 3, 4, or 5`). 0 = 'None'
1 = 'IID' penalized deviates given `sel_sd_prior` 3 = 'Block' time
blocks with no penalty 4 = 'RandomWalk' random walk following Dorn 5 =
